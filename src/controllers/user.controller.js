...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if (
        [fullName, email, username, password].some((field) => field?.trim() === "")   // we can also check them seprately as normal if else conditions
    ){
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    // **** study the difference between user and User ****
